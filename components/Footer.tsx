      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            <h2 className="text-2xl font-bold bg-gradient-to-r from-gold-accent to-yellow-300 text-transparent bg-clip-text">Raj Path</h2>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-gray-300 text-sm">
              ...
              <li><p>rajblogr97@gmail.com</p></li>
        ...
        <div className="mt-8 border-t border-white/20 pt-8 flex flex-col md:flex-row items-center justify-between">
          <div className="flex flex-col md:flex-row items-center gap-x-6 gap-y-4">
            <p className="text-base text-gray-400">&copy; {new Date().getFullYear()} Raj Path. All rights reserved.</p>
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <a href="https://www.linkedin.com/company/rajpath" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white"><LinkedInIcon className="h-6 w-6" /></a>
